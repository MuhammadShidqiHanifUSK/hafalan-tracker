<x-layouts::app title="Detail Setoran Anak">
...
<div class="hafalan-wrap">
    <div class="hafalan-header">
        <div class="hafalan-title-wrap">
            ...
            <div>
                <h1 class="hafalan-title">Detail Setoran Anak</h1>
                <p class="hafalan-subtitle">{{ $setoran->user->name }} — {{ \Carbon\Carbon::parse($setoran->tanggal)->format('d M Y') }}</p>
            </div>
        </div>
        <a href="{{ route('ortu.index') }}" class="btn-kembali">← Kembali</a>
    </div>
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td class="info-value">
                    ...
                    @else
                        <span class="badge-belum">✗ Belum</span>
                        <form action="{{ route('ortu.paraf', $setoran->id) }}" method="POST" style="display:inline; margin-left: 0.5rem;">
                            @csrf
                            @method('PATCH')
    ...
    {{-- Catatan --}}
    <div class="hafalan-card">
        <h2 class="hafalan-card-title">💬 Catatan</h2>
        ...
        <form action="{{ route('catatan.store', $setoran->id) }}" method="POST" style="margin-top: 1rem;">
            ...
            <div class="form-group">
                ...
                <textarea name="isi_catatan" rows="3" placeholder="Tulis catatan untuk ustadz..."
