...
class SurahSeeder extends Seeder
{
    public function run(): void
    {
        $surahs = [
            ...
            [59, 'الحشر', 'Al-Hasyr', 24],
            [60, 'الممتحنة', 'Al-Mumtahanah', 13],
            [61, 'الصف', 'Ash-Shaff', 14],
            ...
            [84, 'الانشقاق', 'Al-Insyiqaq', 25],
            [85, 'البروج', 'Al-Buruj', 22],
            [86, 'الطارق', 'At-Tariq', 17],
            [87, 'الأعلى', 'Al-Ala', 19],
            [88, 'الغاشية', 'Al-Ghasyiyah', 26],
            [89, 'الفجر', 'Al-Fajr', 30],
            [90, 'البلد', 'Al-Balad', 20],
            [91, 'الشمس', 'Asy-Syams', 15],
            [92, 'الليل', 'Al-Lail', 21],
            [93, 'الضحى', 'Adh-Dhuha', 11],
            [94, 'الشرح', 'Al-Insyirah', 8],
            [95, 'التين', 'At-Tin', 8],
            [96, 'العلق', 'Al-Alaq', 19],
            [97, 'القدر', 'Al-Qadr', 5],
            ...
            [102, 'التكاثر', 'At-Takatsur', 8],
            [103, 'العصر', 'Al-Asr', 3],
            [104, 'الهمزة', 'Al-Humazah', 9],
            [105, 'الفيل', 'Al-Fil', 5],
            [106, 'قريش', 'Quraisy', 4],
            [107, 'الماعون', 'Al-Maun', 7],
            [108, 'الكوثر', 'Al-Kautsar', 3],
